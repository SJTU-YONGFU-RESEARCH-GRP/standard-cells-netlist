...
module tb;
  ...
  initial begin
      ...
      #1;
      if (s !== 1'b0 || a !== 1'b0 || x !== 1'b1) $fatal(1, "BENC mismatch");
      m0=1'b1; m1=1'b0; m2=1'b0;
      #1;
      if (s !== 1'b1 || a !== 1'b0 || x !== 1'b0) $fatal(1, "BENC mismatch");
      m0=1'b0; m1=1'b1; m2=1'b0;
      #1;
      if (s !== 1'b1 || a !== 1'b0 || x !== 1'b0) $fatal(1, "BENC mismatch");
      m0=1'b1; m1=1'b1; m2=1'b0;
      #1;
      if (s !== 1'b1 || a !== 1'b0 || x !== 1'b1) $fatal(1, "BENC mismatch");
      m0=1'b0; m1=1'b0; m2=1'b1;
      #1;
      if (s !== 1'b0 || a !== 1'b1 || x !== 1'b1) $fatal(1, "BENC mismatch");
      m0=1'b1; m1=1'b0; m2=1'b1;
      #1;
      if (s !== 1'b0 || a !== 1'b1 || x !== 1'b0) $fatal(1, "BENC mismatch");
